...
void ASprungWheel::SetupConstraint()
{
	...
	MassWheelConstraint->SetConstrainedComponents(RootBody, NAME_None, Axle, NAME_None);
	AxleWheelConstraint->SetConstrainedComponents(RootBody, NAME_None, Wheel, NAME_None);
}
